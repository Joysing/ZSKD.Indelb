...
,case when (t12.FSAFESTOCK-(isnull(t10.FAvbQty,0)+isnull(t9.FQTY,0)+isnull(t13.FQTY,0)))/t12.FSAFESTOCK>=1 then '黑色'
	when (t12.FSAFESTOCK-(isnull(t10.FAvbQty,0)+isnull(t9.FQTY,0)+isnull(t13.FQTY,0)))/t12.FSAFESTOCK<1 
		and (t12.FSAFESTOCK-(isnull(t10.FAvbQty,0)+isnull(t9.FQTY,0)+isnull(t13.FQTY,0)))/t12.FSAFESTOCK>=0.66 then '红色'
	when (t12.FSAFESTOCK-(isnull(t10.FAvbQty,0)+isnull(t9.FQTY,0)+isnull(t13.FQTY,0)))/t12.FSAFESTOCK<0.66 
		and (t12.FSAFESTOCK-(isnull(t10.FAvbQty,0)+isnull(t9.FQTY,0)+isnull(t13.FQTY,0)))/t12.FSAFESTOCK>=0.35 then '黄色'
	when (t12.FSAFESTOCK-(isnull(t10.FAvbQty,0)+isnull(t9.FQTY,0)+isnull(t13.FQTY,0)))/t12.FSAFESTOCK<0.35 
		and (t12.FSAFESTOCK-(isnull(t10.FAvbQty,0)+isnull(t9.FQTY,0)+isnull(t13.FQTY,0)))/t12.FSAFESTOCK>=0 then '绿色'
	else '蓝色' end as '颜色'
