...
def AfterExecuteOperationTransaction(e):
    ...
    for item in e.DataEntitys:
        FID = str(item["Id"]);
        sqlString = "/*dialect*/update t2 set F_ora_PINumber = t1.FBillNo+'-'+Convert(varchar(6),t2.FSeq) from T_PLN_FORECAST t1 join T_PLN_FORECASTENTRY t2 on t1.FID=t2.FID " 
