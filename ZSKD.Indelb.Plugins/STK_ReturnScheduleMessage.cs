    ...
    public class STK_ReturnScheduleMessage: IScheduleService
    {
        ...
        public void Run(Context ctx, Schedule schedule)
        {
            ...
            if (DD_Row.Count > 0) {
                ...
                {
                    string STK_SqlStr = " select FBILLNO,t6.FNAME as FSalName,FQTY,F_ZSKD_ALREADYOUTQTY ,F_ZSKD_DELAYTME,F_ZSKD_RETURNDATE,t6.FPHONE\n" +
                ...
                throw new Exception("星空配置钉钉的\"发送信息\"没有这一行，请配置");
            }
        ...
        public void ReturnError(string response_messContent,Context ctx) {
            ...
            if (DD_RowQXX.Count > 0)
            {
                ...
                throw new Exception("星空配置钉钉的\"发送群信息\"没有这一行，请配置");
            }
